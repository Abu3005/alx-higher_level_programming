...
''' guillaume@ubuntu:~/0x08$ cat 2-main.py #!/usr/bin/python3 Rectangle = import('2-rectangle').Rectangle
...
''' guillaume@ubuntu:~/0x08$ cat 4-main.py #!/usr/bin/python3 Rectangle = import('4-rectangle').Rectangle
